...
{% include figure image_path="/assets/images/posts/2017-12/Kostenlos-Webseite-einrichten/01.jpg" alt="DNSEinrichten" caption="Einrichten der DNS-Einträge bei Namecheap." %}

Anschließend muss man noch die Domain in den Einstellungen des Github-Repos eintragen:

{% include figure image_path="/assets/images/posts/2017-12/Kostenlos-Webseite-einrichten/02.jpg" alt="Github Page einrichten" caption="Eintragen der Domain in den Github Pages-Einstellungen des Repos." %}
